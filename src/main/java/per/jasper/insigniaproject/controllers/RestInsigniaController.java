...
//public class RestInsigniaController {
//    private final InsigniaService insigniaService;
//
//    public RestInsigniaController(InsigniaService insigniaService) {
...
//    }
//    @GetMapping("/competences/{id}/insignia")
//    public ResponseEntity<Insignia> getInsigniaByCompetenceId(@PathVariable("id") long id) {
//        Insignia insignia = insigniaService.getInsigniaByCompetenceId(id);
//        if (insignia == null) {
//            return new ResponseEntity<>(HttpStatus.NOT_FOUND);
//        }
//        return new ResponseEntity<>(insignia, HttpStatus.OK);
